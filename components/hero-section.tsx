  ...
  return (
    <section className="relative overflow-hidden bg-gradient-to-b from-background to-background/80 py-20 md:py-32">
      ...
      <div className="relative z-10 mx-auto max-w-4xl px-4 text-center">
        ...
        >
          <button className="rounded-lg bg-accent px-8 py-3 font-medium text-accent-foreground transition-all hover:shadow-lg hover:shadow-accent/50 active:scale-95">
            Start Exploring
          </button>
        </motion.div>
      </div>
